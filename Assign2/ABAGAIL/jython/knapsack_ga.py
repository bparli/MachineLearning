...
for _ in range(runs):
    ...
    ef.clearCount()
print "GA, average results , " + str(sum(results)/float(runs)) + ", knapsack_ga_%d-%d-%d-%d-%d.txt" % (N, ga_pop,co_type,ga_keep,ga_mut)
print "GA, average feval calls , " + str(sum(calls)/float(runs)) + ", knapsack_ga_%d-%d-%d-%d-%d.txt" % (N, ga_pop,co_type,ga_keep,ga_mut)
t1 = time.time() - t0
print "GA, average time , " + str(t1/float(runs)) + ", knapsack_ga_%d-%d-%d-%d-%d.txt" % (N, ga_pop,co_type,ga_keep,ga_mut)
